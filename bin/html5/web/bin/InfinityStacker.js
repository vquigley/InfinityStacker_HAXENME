...
ApplicationMain.preloader_onComplete = function(event) {
	...
	if(Reflect.field(com.twinnova.infinitystacker.Main,"main") == null) {
		var mainDisplayObj = new com.twinnova.infinitystacker.Main();
		if(js.Boot.__instanceof(mainDisplayObj,jeash.display.DisplayObject)) nme.Lib.nmeGetCurrent().addChild(mainDisplayObj);
	} else Reflect.field(com.twinnova.infinitystacker.Main,"main").apply(com.twinnova.infinitystacker.Main,[]);
}
...
var com = {}
com.twinnova = {}
com.twinnova.infinitystacker = {}
com.twinnova.infinitystacker.Main = function() {
	jeash.display.Sprite.call(this);
	this.addEventListener(jeash.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["com.twinnova.infinitystacker.Main"] = com.twinnova.infinitystacker.Main;
com.twinnova.infinitystacker.Main.__name__ = ["com","twinnova","infinitystacker","Main"];
com.twinnova.infinitystacker.Main.__super__ = jeash.display.Sprite;
com.twinnova.infinitystacker.Main.prototype = $extend(jeash.display.Sprite.prototype,{
	init: function(e) {
	}
	,__class__: com.twinnova.infinitystacker.Main
});
var haxe = {}
