...
{
		HX_STACK_PUSH("Main::fillGrid","com/twinnova/infinitystacker/Main.hx",58);
		HX_STACK_LINE(59)
...
{
		HX_STACK_PUSH("Main::addRow","com/twinnova/infinitystacker/Main.hx",68);
...
{
		HX_STACK_PUSH("Main::addSquare","com/twinnova/infinitystacker/Main.hx",78);
		HX_STACK_ARG(rowNumber,"rowNumber");
